...
class Enemy():
    def __init__(self, currentenemy):
...
class MyStreamListener(tweepy.StreamListener):
    ...
    def on_status(self, status):
        ...
        elif self.myPlayer.name != "Player" and self.battling == 0:
    ...
    def enemyTurn(self, command, enemystate):
        ...
        if enemymove == 1:
            ...
            Display(self.currentenemy['name'] + " attacks! " + str(damage) + " damage to " + self.myPlayer.name + "!\nCurrent health: " + str(self.playerstate.health) + "/" + str(self.playerbase.health))
        #keep deathCheck() at the end
        self.deathCheck(enemystate)
